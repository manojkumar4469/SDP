...
<body>
<div class="navbar">
  <a href="customerhome">Car ShowRoom Management System</a>
  <div class="dropdown">
    <button class="dropbtn">Options
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="viewcus">View Profile</a>
      <a href="viewallcars">View all Cars</a>
      <a href="cchangepwd">Change Password</a>
...
<section class="footer" id="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="#"> <i class="fas fa-phone"></i> +91 1122334455 </a>
            <a href="#"> <i class="fas fa-phone"></i> +91 6677889900 </a>
            <a href="#"> <i class="fas fa-envelope"></i> pavan@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> Vijayawada, india - 400104 </a>
        </div>
