...
<section class="services" id="services">
    ...
    <h1 class="heading"> All <span>Cars</span> </h1>

    <div class="box-container">

        <div class="box">
            <i class="fas fa-car"></i>
            <img src="images/cpic2.jpg" alt=pcar1>
           <b> <h3>Hyundai</h3>
            <p>i10</p>
            <p>20 kmpl</p>
            <p>INR 1000000 /-</p></b>
            <a href="#" class="btn" style="color: white"> read more</a>
        </div>

        <div class="box">
            <i class="fas fa-tools"></i>
            <img src="images/cpic1.jpg" alt=pcar1>
           <b> <h3>Mahindra</h3>
            <p>Scorpio</p>
            <p>23 kmpl</p>
            <p>INR 1300000 /-</p></b>
        ...
        <div class="box">
            ...
            <img src="images/cpic3.jpg" alt=pcar1>
           <b> <h3>BMW</h3>
            <p>3 Series</p>
            <p>20 kmpl</p>
            <p>INR 4600000 /-</p></b>
        ...
        <div class="box">
            ...
            <img src="images/cpic4.jpg" alt=pcar1>
           <b> <h3>Mahindra</h3>
            <p>XUV700</p>
            <p>22 kmpl</p>
            <p>INR 1300000 /-</p></b>
        ...
        <div class="box">
            ...
            <img src="images/cpic5.jpg" alt=pcar1>
            <b><h3>Mahindra</h3>
            <p>XUV300</p>
            <p>24 kmpl</p>
            <p>INR 800000 /-</p></b>
        ...
        <div class="box">
            ...
            <img src="images/cpic6.jpg" alt=pcar1>
           <b> <h3>Skoda</h3>
            <p>Kushaq</p>
            <p>23 kmpl</p>
            <p>INR 1129000 /-</p></b>
...
<img alt="cpic" src="images/cpic.jpg" style="width: 100%">
<h4><b>Name : <c:out value="${car.carname}"></c:out></b></h4>
<h4>Model : <c:out value="${car.model}"></c:out></h4>
<h4>Milage : <c:out value="${car.milage}"></c:out></h4>
<h4>Price : <c:out value="${car.price}"></c:out></h4>
</div>
</div>
</c:forEach>
...
<td> <c:out value="${car.carname}"></c:out>   </td>
<td> <c:out value="${car.model}"></c:out>   </td>
<td> <c:out value="${car.milage}"></c:out>   </td>
<td> <c:out value="${car.price}"></c:out>   </td>
<td> 
<a href='<c:url value='deletecar?id=${car.carname}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a href='<c:url value='viewcarbyid?id=${car.carname}'></c:url>'>View</a>&nbsp;&nbsp;
</td>
</tr>
</c:forEach>
</table>
